...
const companyLinks = [
  ...
  // Exigé par Google Play : la page de suppression (compte et données) doit
  // être atteignable depuis le site, et son URL est inscrite dans la fiche Play.
  { href: "/suppression", label: "Supprimer mes données ou mon compte" },
];
