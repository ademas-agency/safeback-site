        ...
        <div className="prose prose-gray max-w-none space-y-8">
          ...
          <section>
            ...
            <ul className="list-disc pl-6 space-y-2 text-gray-600">
              ...
              <li>supprimer votre compte depuis l&apos;application (la suppression efface votre compte, vos contacts, vos alertes, votre historique de position et vos enregistrements) ;</li>
