...
- `/suppression` — page « Supprimer vos données ou votre compte », UNE page pour les
  ...
  Sécurité des données). **URL et ancres inscrites dans la fiche Play : ne pas les
  renommer.** L'ancienne adresse `/suppression-compte` redirige vers elle. Le texte vient
